...
# Perform face detection  --  clouds
    faces = face_cascade.detectMultiScale(img, scaleFactor=1.10, minNeighbors=3)
    faces1 = face1_cascade.detectMultiScale(img, scaleFactor=1.10, minNeighbors=3)
...
# Perform face detection  --- Cemetery
    faces = face_cascade.detectMultiScale(img, scaleFactor=1.01, minNeighbors=9)
